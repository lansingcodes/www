<template>
  ...
  >
    ...
    <eventCard
      ...
      class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-8 mx-auto"
...
export default {
  ...
  methods: {
    ...
    expandEventCard(emittedEventId) {
      this.expandedEventId = emittedEventId
    },
    collapseEventCard(emittedEventId) {
      if (this.expandedEventId === emittedEventId) {
