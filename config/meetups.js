export default [
  // 1st Tuesday
  {
    name: 'DevOps',
    desc:
      "If you want to actually <em>ship</em>, scale, or collaborate with a team, here's where you learn how.",
    icon: 'fa-server',
  ...
  // 1st Thursday
  {
    name: 'CocoaHeads',
    desc:
      'For those interested in developing for the Apple ecosystem: Swift, Objective-C, iOS, Apple Watch, macOS, tvOS, and related topics.',
    icon: 'fa-apple',
